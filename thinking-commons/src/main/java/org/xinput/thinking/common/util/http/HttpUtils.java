package org.xinput.thinking.common.util.http;
...
import org.xinput.thinking.common.exception.HttpUtilException;
...
public class HttpUtils {
  ...
  public static String get(String url, Map<String, Object> params, List<Map<String, String>> headers, Charset charset) throws IOException {
    ...
    if (!validUrl(urlString)) {
      throw new HttpUtilException(StringUtils.join("url不符合规范,url : ", urlString));
    }
  ...
  public static String post(String url, Object params, List<Map<String, String>> headers, Charset charset) throws IOException {
    ...
    if (validUrl(url)) {
      throw new HttpUtilException(StringUtils.join("url不符合规范,url : ", url));
    }
    HttpPost httpPost = new HttpPost(url);
    setCommonHeaders(httpPost, headers);
    httpPost.setEntity(new StringEntity(JsonUtils.toJsonString(params), charset));
  ...
  public static String put(String url, Object params, List<Map<String, String>> headers, Charset charset) throws IOException {
    ...
    httpPut.setEntity(new StringEntity(JsonUtils.toJsonString(params), charset));
  ...
  public static boolean validUrl(String url) {
    if (StringUtils.isBlank(url)
        || !StringUtils.startsWithAny(url.toLowerCase(), "http://", "https://")) {
      return false;
    }
